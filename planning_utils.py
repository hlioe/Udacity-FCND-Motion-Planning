...
def prune_path(path):
    ...
    while i < len(pruned_path) - 2:
        ...
        if collinearity_check(p1, p2, p3, 1):
...
def closest_point(graph, current_point):
    ...
    print ('Found closest_point -> current_point', current_point, closest_point)
    ...
    while not queue.empty():
        ...
        if current_node == goal:        
            ...
            for next_node in graph[current_node]:
                ...
                #print('current_node, next_node, cost, new_cost', current_node, next_node, cost, new_cost)
                
                if next_node not in visited:                
                    #print('add next_node, new_cost', next_node, new_cost)
